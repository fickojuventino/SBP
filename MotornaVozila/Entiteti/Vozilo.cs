...
namespace MotornaVozila.Entiteti
{
    ...
    public class Vozilo
    {
        ...
        public virtual long brojSasije { get; set; }
        public virtual string boja { get; set; }
        //public virtual int idSalona { get; protected set; }
        public virtual long brojMotora { get; protected set; }
        ...
        public virtual long nosivost { get; set; }
        ...
        public virtual long registarskiBroj { get; protected set; }
